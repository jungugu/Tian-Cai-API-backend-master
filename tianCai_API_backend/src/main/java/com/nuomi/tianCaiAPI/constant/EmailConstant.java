package com.nuomi.tianCaiAPI.constant;
...
public interface EmailConstant {
     ...
     * 电子邮件标题
     */
    String EMAIL_TITLE = "Tian-Cai-API 接口开放平台";

    /**
     * 电子邮件标题英语
     */
    String EMAIL_TITLE_ENGLISH = "Tian-Cai-API Open Interface Platform";

    /**
     * 平台负责人
     */
    String PLATFORM_RESPONSIBLE_PERSON = "糯米工作室";

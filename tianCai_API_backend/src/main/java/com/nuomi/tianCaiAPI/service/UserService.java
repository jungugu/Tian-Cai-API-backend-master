...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    long userRegisterByEmail(String emailAccount, String captcha, String userName, String inviteCode);
    ...
    boolean addCoinBalance(Long userId, Long addCoins);
